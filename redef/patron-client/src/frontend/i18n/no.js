...
export default {
  ...
  'SearchResultsText.totalHits': '<span data-automation-id="hits-total">{totalHits}</span> (<span>{totalHitsPublications}</span>) treff på "<span data-automation-id="current-search-term" class="result-name">{searchQuery}</span>"',
